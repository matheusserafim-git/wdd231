export const items = [
  ...
  },
  {
    ...
    "address": "Largo Dr. Maurício Cardoso, 42 - Centro, Canoas - RS",
    "description": "Importante marco arquitetônico e religioso localizado no coração da cidade.",
    "photo": "images/catedral.webp"
  },
  {
    "name": "ParkShopping Canoas",
    "address": "Av. Farroupilha, 4545 - Mal. Rondon, Canoas - RS",
    "description": "Moderno centro de compras, gastronomia e entretenimento integrado a uma grande reserva de parque urbano.",
    "photo": "images/shopping.webp"
  },
  {
